...
void AddRuleDialog::setupUi() {
    ...
    m_warningLabel->setText(
        "<b>How it works:</b> This creates a udev rule with <code>MODE=\"0666\"</code> which allows "
        "browsers to access the device for WebHID. The browser will still ask for your permission.<br>"
